...
주제를 입력하면 AI가 자동으로 정보를 수집하고, 대본을 작성하고, 음성으로 변환하여 2인 대화 팟캐스트를 생성하는 간단한 웹 애플리케이션입니다.

![AI 팟캐스트 생성기](app_introduction/app_image.png)
...
- 📝 [생성된 대본](app_introduction/podcast_script_세상의_신비한_동물들.txt)
- 🎧 [생성된 팟캐스트 오디오](app_introduction/podcast_세상의_신비한_동물들.mp3)
...
├── app_introduction/     # 예시 결과물
│   ├── app_image.png     # 앱 스크린샷
│   ├── podcast_script_세상의_신비한_동물들.txt  # 예시 대본
│   └── podcast_세상의_신비한_동물들.mp3         # 예시 오디오
└── .gitignore
```
